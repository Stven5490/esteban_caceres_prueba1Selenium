...
public class testEdwards {
    ...
    public void CP001_llegarSitioEdwards(){
        driver.get("https://portales.bancoedwards.cl/personas");
    ...
    public void CP003_hazteClienteok() throws InterruptedException {
        ...
        Apellidos.sendKeys("Cáceres Creuz");
        //Rut
    ...
    @Test
    public void hazteCliente() throws InterruptedException {
        CP003_hazteClienteok();
    }
